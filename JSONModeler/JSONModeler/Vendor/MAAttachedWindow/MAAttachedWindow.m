...
- (NSColor *) colorWithHex: (uint) rgbValue;
...
- (NSColor *)_backgroundColorPatternImage
{
    ...
    [[[NSGradient alloc]
      initWithStartingColor:[self colorWithHex:0xec3636]
      endingColor:[self colorWithHex:0xdf3333]]
     autorelease];
//    [_MABackgroundColor set];
    //[bgPath fill];
    [borderGradient drawInBezierPath:bgPath angle:-90];
