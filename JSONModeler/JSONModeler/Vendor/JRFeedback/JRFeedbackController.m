...
- (id)init {
    self = [super initWithWindowNibName:@"JRFeedbackProviderRevised"];
    if (self) {
...
- (IBAction)switchSectionAction:(NSSegmentedControl*)sender {
    ...
    currentSection = (JRFeedbackController_Section) [sender selectedSegment];
...
+ (NSURL*)postURL {
    ...
    if(postURLString == nil) {
        postURLString = @"http://www.jsonmodeler.com/feedback.php";
    }
