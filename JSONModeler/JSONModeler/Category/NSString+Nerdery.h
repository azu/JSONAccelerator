...
/**
 * Returns a string by removing all characters except those in the set [A-Za-z0-9_]. Also returns by reference a BOOL that indicates whether the returned string is an Objective-C reserved word. Note: this method will return the empty string if the receiver consists entirely of characters outside the alphanumeric set.
 *
...
/**
 * Returns a string created by removing all non-alphanumeric characters from the receiver, checking if this string is an Objective-C reserved word, and appending the string "Class" if so. The first letter will be capitalized. If the first character (after removing non-alphanumeric characters) is a numeral, the string will be prefixed with "Num". Note: this method will return the empty string if the receiver consists entirely of characters outside the alphanumeric set [A-Za-z0-9_].
 *
